...
// (ADR-0022): the Convex storage upload-URL mint and the raw byte POST. The Drive
// token-minting action is gone from the submit path — that upload_all now runs in
// the deferred Base-write worker (the SPA passes staged storageIds to syncRequest
