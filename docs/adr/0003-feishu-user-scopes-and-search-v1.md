...
- **Short-query guard.** The taskpane coworker search starts remote lookup at two characters. One-character input is too broad for Feishu Search Users and returns no remote results instead of calling Convex/Feishu.
