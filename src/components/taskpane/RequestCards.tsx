...
export const REQUESTS: RequestDef[] = [
  ...
  },
  {
    ...
    title: "Sample",
    dot: "var(--sage)",
    placeholder: "Need 50 g of SX‑440 silica blend, ship to Acme R&D — Eindhoven.",
  },
  {
    id: "rd",
    title: "R&D Support",
    dot: "#7a5bb5",
    placeholder: "Describe the challenge, target spec, constraints…",
  },
];

const ITEM_CLASS =
  "group bg-card rounded-[22px] border border-transparent shadow-sm transition-all data-[state=open]:border-border data-[state=open]:shadow-md";
      ...
      {REQUESTS.map((r) => {
        ...
        return (
          <AccordionItem key={r.id} value={r.id} className={ITEM_CLASS}>
            <AccordionTrigger className="px-5 py-[18px]">
