    ...
    <div className="relative">
      ...
      {open ? (
        <div
          ...
          className="bg-popover text-popover-foreground absolute inset-x-0 top-[calc(100%+0.45rem)] z-40 max-h-64 overflow-y-auto rounded-2xl p-1.5 shadow-[var(--shadow-floating)]"
        >
